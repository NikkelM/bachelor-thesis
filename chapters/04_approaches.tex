...
\begin{enumerate}
	...
	\item Marketplace: Using this parameter, the user can set the marketplace on which the monitoring session will be run. A wide variety of scenarios is available, which are explained in \todo{Section reference to introduction where the scenarios are explained}.
\end{enumerate}
