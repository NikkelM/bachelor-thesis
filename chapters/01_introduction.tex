...
\subsection*{Using the simulated marketplace to train agents}\label{subsec:ReinforcementLearningIntroduction}\todo{Alex: `Du bringst in der Einführung in der Erklärung des Marktes recht überraschend die Grundidee von RL. Das würde ich vielliecht in eine Extra-Sektion schieben.' -> evtl. in related work?}
