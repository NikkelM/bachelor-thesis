...
\begin{figure}[t]
	...
	\caption{Class diagram outlining interactions between the most important classes in our framework.}\label{fig:OverviewDiagram}
\end{figure}
