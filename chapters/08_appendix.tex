\section*{A.1\space\space Tables}
...
\newpage
\section*{A.2\space\space Rule-Based agents - Policies}
...
\clearpage
\section*{A.3\space\space SAC-Duopoly experiment - Configuration files}
...
\clearpage
\section*{A.4\space\space PPO-Oligopoly experiment}\label{sec:AppendixOligopoly}

\section*{A.4.1\space\space Configuration files}

\section*{A.4.1\space\space Diagrams}
