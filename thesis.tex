...
%    \boldNumberSetsfalse % Use this value if you want variables for number sets (like N or R) to appear in blackboard bold rather than bold.
    ...
    \myTitle{Monitoring Reliability and Robustness of Agents for Dynamic Pricing in different (Re-)Commerce Markets}
    ...
    \myKeywords{bachelor thesis | reinforcement learning | python | dynamic pricing | recommerce | monitoring | reliability | robustness}
...
\input{to_be_ordered/good_agent}

\chapter{Different approaches}
\input{to_be_ordered/approaches}

\chapter{Our workflow}
\input{to_be_ordered/workflow}

\chapter{Interpreting the results}
\input{to_be_ordered/interpret_results}
